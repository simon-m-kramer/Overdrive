...
#include "Starter/OverdriveOffroadCar.h"
#include "Starter/OverdriveOffroadWheelFront.h"
#include "Starter/OverdriveOffroadWheelRear.h"
...
AOverdriveOffroadCar::AOverdriveOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UOverdriveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UOverdriveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UOverdriveOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UOverdriveOffroadWheelRear::StaticClass();
