...
class AOverdrivePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AOverdrivePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AOverdrivePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UOverdriveUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UOverdriveUI> VehicleUI;
